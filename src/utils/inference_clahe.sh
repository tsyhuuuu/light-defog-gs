...
for NAME in "${NAMES[@]}"; do
    ...
    for beta in "${BETAS[@]}"; do
        for alpha in "${ALPHAS[@]}"; do
            ...
            # Define paths
            RENDER_DIR="/home/tsy/Documents/TeamM_Defog/kpro-dehaze/data/test/tandt_db/${BETA_ALPHA}/${NAME}/rendered/ours_30000"
            RENDER_PATH="${RENDER_DIR}/renders_defogged_clahe"
            GT_PATH="${RENDER_DIR}/gt"
            SAVE_DIR="${RENDER_DIR}"
            ...
            python metrics.py \
                ...
                -g "$GT_PATH" \
                --save_dir "$SAVE_DIR" \
                --save_name "results_defogged_clahe.json"
