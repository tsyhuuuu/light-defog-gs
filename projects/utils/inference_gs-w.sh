...
# Target object
NAMES=("db/playroom" "db/drjohnson" "tandt/train" "tandt/truck")     # db/drjohnson | db/playroom | tandt/train | tandt/truck

# Beta and Alpha values
BETAS=(1 2 3 4 5 6)  # you can expand: (1 2 3 4 5 6)
ALPHAS=(025 050 075 100 125 150 175 200 225)
...
for NAME in "${NAMES[@]}"; do
    ...
    for beta in "${BETAS[@]}"; do
        for alpha in "${ALPHAS[@]}"; do
            ...
            # Define paths
            RENDER_DIR="/home/tsy/Documents/TeamM_Defog/references/Gaussian-Wild/outputs/${NAME##*/}_beta${BETA}_alpha${ALPHA}/train/ours_30000"
            RENDER_PATH="${RENDER_DIR}/renders"
            GT_PATH="/home/tsy/Documents/TeamM_Defog/kpro-dehaze/data/test/tandt_db/${BETA_ALPHA}/${NAME}/rendered/ours_30000/gt"
